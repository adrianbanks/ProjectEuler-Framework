...
{
    [Problem(43)]
    internal sealed class Problem43 : BaseProblem
    {
        public override DateTime DateSet{get {return new DateTime(2003, 5, 9);}}

        public override string Title
        {
            get
            {
                return "Find the sum of all pandigital numbers with an unusual sub-string divisibility property.";
            }
        }
